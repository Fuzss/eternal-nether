...
- Fix some wrong asset locations thanks to [seriousfreezing](https://github.com/seriousfreezing)

## [v26.1.2-mc26.1.x] - 2026-06-06

### Fixed

- Fix `java.lang.IllegalStateException`: Unregistered memory fetched: `minecraft:angry_at`
