...
public class ModTrimMaterialTagsProvider extends AbstractTagProvider<TrimMaterial> {
    ...
    public void addTags(HolderLookup.Provider registries) {
        this.tag(ModTags.PIGLIN_SAFE_TRIM_MATERIAL_TAG_KEY).add(TrimMaterials.GOLD);
    }
}
